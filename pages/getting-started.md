...
```powershell
Install-Module -Repository PSGallery -Name 'Brownserve.PSBuildTools'
Import-Module 'Brownserve.PSBuildTools'
```
...
See the [Cmdlet reference](Cmdlet%20reference/Commands.md) for a full list of available commands and their parameters.
